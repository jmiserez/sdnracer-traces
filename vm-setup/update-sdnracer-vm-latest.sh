...
rm -f PLDITutorial.html
rm -rf PLDITutorial_files
rm -f ~/Desktop/PLDITutorial.html
...
# wget http://s3.miserez.org/sdnracer-pldi/colin_scott-hassel-sts-31afb29fa667.zip
...
wget https://github.com/jmiserez/sdnracer-traces/blob/artifact/vm-setup/update-this-vm.sh -O update-this-vm.sh
wget https://github.com/jmiserez/sdnracer-traces/blob/artifact/vm-setup/reset-this-vm.sh -O reset-this-vm.sh
