...
steps = 200
results_dir = "traces/trace_floodlight_forwarding-%s%d-steps%s" % (topology_class.__name__, num, steps)
...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_floodlight_forwarding-BinaryLeafTreeTopology1-steps200/fuzzer_params.py'")