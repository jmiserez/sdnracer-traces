...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_pox_eel_l2_multi_fixed-BinaryLeafTreeTopology2-steps200/fuzzer_params.py'")