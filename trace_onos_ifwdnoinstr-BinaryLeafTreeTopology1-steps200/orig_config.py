...
steps = 200
results_dir = "traces/trace_onos-noinstr-ifwd-%s%d-steps%s" % (topology_class.__name__, num, steps)
...
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_onos-noinstr-ifwd-BinaryLeafTreeTopology1-steps200/fuzzer_params.py'")