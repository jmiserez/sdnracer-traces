...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_pox_eel_learningswitch-BinaryLeafTreeTopology1-steps200/fuzzer_params.py'")