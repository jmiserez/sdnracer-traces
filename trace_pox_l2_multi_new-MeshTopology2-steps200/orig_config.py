...
results_dir = "traces/trace_pox_l2_multi_new-%s%d-steps%s" % (topology_class.__name__, num, steps)
...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_pox_l2_multi_new-MeshTopology2-steps200/fuzzer_params.py'")