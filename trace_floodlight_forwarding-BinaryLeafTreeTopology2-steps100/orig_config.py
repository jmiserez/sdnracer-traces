...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_floodlight_forwarding-BinaryLeafTreeTopology2-steps100/fuzzer_params.py'")