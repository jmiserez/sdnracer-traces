...
results_dir = "traces/floodlight_hb_circuitpusher-bintree3-traffic-failures"
...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/floodlight_hb_circuitpusher-bintree3-traffic-failures/fuzzer_params.py'")