...
results_dir = "traces/trace_pox_hb_l2_learning-%s%d-steps%d" % (topology_class.__name__, num, steps)
...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/trace_pox_hb_l2_learning-StarTopology3-steps100/fuzzer_params.py'")