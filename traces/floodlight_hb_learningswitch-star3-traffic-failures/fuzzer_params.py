switch_failure_rate = 0.2
switch_recovery_rate = 0.8
...
app_circuitpusher_add_rate = 0.8
app_circuitpusher_add_parallelism = 1
app_circuitpusher_del_rate = 0.2
app_circuitpusher_del_parallelism = 1
