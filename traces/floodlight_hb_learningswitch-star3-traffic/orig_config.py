...
results_dir = "traces/floodlight_hb_learningswitch-star3-traffic"
...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/floodlight_hb_learningswitch-star3-traffic/fuzzer_params.py'")