...
results_dir = "traces/pox_l2_multi-star3-traffic"
...
#                       invariant_check_name="check_everything",
                      ...
                      apps=apps)
raise RuntimeError("Please add this parameter to Fuzzer: fuzzer_params='traces/pox_l2_multi-star3-traffic/fuzzer_params.py'")